    ...
    body = (
      <div className={classes.paper}>
        ...
        <div className={classes.infoContainer}>
          ...
          <div className={classes.chipContainer}>{['Business', 'Entertainment', 'General', 'Health', 'Science', 'Sports', 'Technology'].map((category) => <Chip label={category} color="primary" className={classes.chip} key={category} />)}</div>
        </div>
        ...
        <div className={classes.infoContainer}>
          ...
          <div className={classes.chipContainer}>{['Donald Trump', 'Bitcoin', 'PlayStation 5', 'Smartphones'].map((term) => <Chip label={term} color="primary" className={classes.chip} key={term} />)}<Chip label="...and more" className={classes.chip} /></div>
        </div>
        ...
        <div className={classes.infoContainer}>
          ...
          <div className={classes.chipContainer}>{['CNN', 'Wired', 'BBC News', 'Time', 'IGN', 'Buzzfeed', 'ABC News'].map((source) => <Chip label={source} color="primary" className={classes.chip} key={source} />)}<Chip label="...and more" className={classes.chip} /></div>
        </div>
